	...
	<body>
		...
		<nav>
			<ul>
				...
				<li><a class="authLink" href="register.php">Register</a></li>
			</ul>
		</nav>
		<img src="banners/1.jpg" alt="Banner" />

		<!-- <section class="auth-section">
    <h2>Join Carbuy Auctions Today!</h2>
    <p>Register now to start bidding on your dream car or login if you're already a member.</p>
